#!/usr/bin/env python3
"""Deterministic GM45 stride-aware packed addition test for YOLO decode."""
...
def main() -> int:
    ...
    print("GM45 stride-aware packed addition")
    ...
    print(f"  right: shape={list(rb.shape)} strides={rb._logical_strides} texture=#{rb._owner.texture} offset={rb._storage_offset}")
