...
class OpenGLBackend(Backend):
    """Adapter exposing the existing OpenGL implementation to MatrixMan."""

    name = "opengl"

    @classmethod
    def probe(cls) -> bool:
        """Return whether MatrixMan can create its required GL context."""
        try:
            init()
        except Exception:
            return False
    ...
    def matmul(self, a, b):
        return _render_binary("matmul", a, b)
...
class Gm45Tensor(torch.Tensor):
    ...
    def __torch_dispatch__(cls, func, types, args=(), kwargs=None):
        ...
        if func is torch.ops.aten.mm.default:
            ...
            return get_backend().matmul(args[0], args[1])
