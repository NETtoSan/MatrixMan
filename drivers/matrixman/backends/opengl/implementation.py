...
_relu_program = _activation._relu_program
_relu_shader_source = _activation._relu_shader_source
_render_relu_inplace = _activation._render_relu_inplace
_render_relu_functional = _activation._render_relu_functional
